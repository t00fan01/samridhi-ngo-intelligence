  ...
  return (
    <div className="flex-1 p-6 lg:p-8 max-w-7xl mx-auto w-full flex flex-col gap-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-white rounded-2xl p-6 shadow-sm border border-slate-100 flex items-center gap-4 hover:shadow-md transition-shadow">
          ...
          <div>
            ...
            <p className="text-3xl font-bold text-slate-900">{totalNeeds}</p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl p-6 shadow-sm border border-slate-100 flex items-center gap-4 hover:shadow-md transition-shadow">
          ...
          <div>
            ...
            <p className="text-3xl font-bold text-slate-900">{highUrgencyCount}</p>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 flex-1 min-h-[500px]">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-slate-100 flex flex-col overflow-hidden max-h-[600px]">
          ...
          <div className="flex-1 overflow-y-auto p-4 space-y-4">
            {needs.length === 0 ? (
              ...
              needs.map(need => (
                <div key={need.id} className="p-4 rounded-xl border border-slate-100 bg-slate-50 hover:bg-white hover:shadow-sm transition-all">
        ...
        <div className="lg:col-span-2 bg-slate-100 rounded-2xl border border-slate-200 overflow-hidden shadow-sm relative h-[400px] lg:h-auto z-0 bg-white">
